...
/// 生命周期-设备报废页面类
class EquipmentScrap extends StatefulWidget{
  static String tag = 'equipment-scrap';

  _EquipmentScrapState createState() => new _EquipmentScrapState();
}

class _EquipmentScrapState extends State<EquipmentScrap> {
                      ...
                      children: [
                        ...
                        new ExpansionPanel(canTapOnHeader: true,
                          ...
                          body: new Padding(
                            ...
                            child: new Column(
                              children: <Widget>[
                                BuildWidget.buildRow('类型', '报废'),
                                BuildWidget.buildRow('主题', _equipment==null?'--报废':'${_equipment['Name']}--报废'),
                                BuildWidget.buildRow('请求人', _roleName),
                                new Divider(),
                                BuildWidget.buildInput('报废备注', _fault, focusNode: _focus, maxLength: 200, lines: 3, required: true),
                                new Padding(
                                  padding: EdgeInsets.symmetric(vertical: 5.0),
                                  child: new Row(
                                    children: <Widget>[
