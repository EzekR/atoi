                          ...
                          body: new Padding(
                            ...
                            child: new Column(
                              children: <Widget>[
                                ...
                                BuildWidget.buildRow('主题',
                                    '${_equipments.length == 1 ? _equipments[0]['Name'] : '多设备'}--盘点'),
                                BuildWidget.buildRow('请求人', _roleName),
                                new Divider(),
                                BuildWidget.buildInput('盘点备注', _fault, focusNode: _focus, maxLength: 200, lines: 3, required: true),
                                new Padding(
                                  padding: EdgeInsets.symmetric(vertical: 5.0),
                                  child: new Row(
                                    children: <Widget>[
