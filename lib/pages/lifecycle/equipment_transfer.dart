...
class _EquipmentTransferState extends State<EquipmentTransfer> {
    ...
    if (_fault.text.isEmpty || _fault.text == null) {
      ...
      for (var image in _imageList) {
        ...
        var file = {
          ...
          'FileName': 'transfer_${Uuid().v1()}.jpg',
          'FileType': 1,
          'ID': 0
        };
        fileList.add(file);
                      ...
                      children: [
                        ...
                        new ExpansionPanel(canTapOnHeader: true,
                          ...
                          body: new Padding(
                            ...
                            child: new Column(
                              children: <Widget>[
                                BuildWidget.buildRow('类型', '设备调拨'),
                                BuildWidget.buildRow('主题', _equipment==null?'--设备调拨':'${_equipment['Name']}--设备调拨'),
                                BuildWidget.buildRow('请求人', _roleName),
                                new Divider(),
                                BuildWidget.buildInput('调拨备注', _fault, focusNode: _focus, maxLength: 200, lines: 3, required: true),
                                new Padding(
                                  padding: EdgeInsets.symmetric(vertical: 5.0),
                                  child: new Row(
                                    children: <Widget>[
