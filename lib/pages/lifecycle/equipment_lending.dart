...
class EquipmentLending extends StatefulWidget{
  ...
  _EquipmentLendingState createState() => new _EquipmentLendingState();
}
                          ...
                          body: new Padding(
                            ...
                            child: new Column(
                              children: <Widget>[
                                ...
                                new Divider(),
                                BuildWidget.buildInput('借用备注', _fault, focusNode: _focus, maxLength: 200, lines: 3, required: true),
                                new Padding(
                                  padding: EdgeInsets.symmetric(vertical: 5.0),
                                  child: new Row(
                                    children: <Widget>[
