                          ...
                          body: new Padding(
                            ...
                            child: new Column(
                              children: <Widget>[
                                ...
                                new Divider(),
                                BuildWidget.buildDropdown('来源', _currentResult, _dropDownMenuItems, changedDropDownMethod, required: true),
                                BuildWidget.buildInput('不良事件描述', _fault, focusNode: _focus, maxLength: 200, lines: 3, required: true),
                                new Padding(
                                  padding: EdgeInsets.symmetric(vertical: 5.0),
                                  child: new Row(
                                    children: <Widget>[
