...
class CorrectionRequest extends StatefulWidget{
  ...
  _CorrectionRequestState createState() => new _CorrectionRequestState();
}
    ...
    if (_fault.text.isEmpty || _fault.text == null) {
      ...
      for (var image in _imageList) {
        ...
        var file = {
          ...
          'FileName': 'correction_${Uuid().v1()}.jpg',
          'FileType': 1,
          'ID': 0
        };
        fileList.add(file);
                          ...
                          body: new Padding(
                            ...
                            child: new Column(
                              children: <Widget>[
                                ...
                                new Divider(),
                                BuildWidget.buildInput('校准要求', _fault, focusNode: _focus, maxLength: 200, lines: 3, required: true),
                                new Padding(
                                  padding: EdgeInsets.symmetric(vertical: 5.0),
                                  child: new Row(
                                    children: <Widget>[
