...
class EquipmentRequest extends StatefulWidget{
  ...
  _EquipmentRequestState createState() => new _EquipmentRequestState();
}

class _EquipmentRequestState extends State<EquipmentRequest> {
                          ...
                          body: new Padding(
                            ...
                            child: new Column(
                              children: <Widget>[
                                ...
                                buildRow('主题：', _equipment.isEmpty?'--设备新增':'${_equipment['Name']}--设备新增'),
                                new Padding(
                                  padding: EdgeInsets.symmetric(vertical: 5.0),
                                  child: new Row(
                                    children: <Widget>[
