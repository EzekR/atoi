...
class ReportList extends StatefulWidget {
  ...
  ReportList({Key key, this.showContent}):super(key: key);
...
class _ReportListState extends State<ReportList> {
            ...
            onTap: () {
              switch (item['type']) {
                ...
                case 'barchart_2':
                  ...
                  break;
                case 'linechart_1':
                  Navigator.of(context).push(new MaterialPageRoute(builder: (context) => new EquipmentLinechart(chartName: item['name'], endpoint: item['endpoint'], labelY: item['label-y'],)));
                  break;
                case 'linechart_2':
                ...
                case 's_barchart_2':
                  ...
                  break;
                case 's_barchart_3':
                  Navigator.of(context).push(new MaterialPageRoute(builder: (context) => new ServiceBarchartB(chartName: item['name'], endpoint: item['endpoint'], labelY: item['label-y'],)));
                  break;
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
        ...
        body: new ListView(
          children: <Widget>[
            (widget.showContent == null|| widget.showContent == 'equip')?new Container(
              decoration: BoxDecoration(
            ...
            (widget.showContent == null|| widget.showContent == 'equip')?new Column(
              children: <Widget>[
                new ListTile(
            ...
            (widget.showContent == null|| widget.showContent == 'service')?new Container(
              decoration: BoxDecoration(
                color: Color.fromRGBO(47,92,133,0.20),
              ),
              child: new Padding(
            ...
            (widget.showContent == null|| widget.showContent == 'service')?new Column(
              children: <Widget>[
                new ListTile(
                  leading: Icon(Icons.receipt, color: Color(0xff2F5C85),),
