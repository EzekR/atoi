...
// import 'package:atoi/utils/oktoast.dart';
import 'package:atoi/utils/toast.dart';
                ...
                ButtonBar(
                  ...
                  children: <Widget>[
                    ...
                    RaisedButton(
                      child: Text('普通toast'),
                      onPressed: () => {
                        // XToast.toast("这是一个普通的Toast")
                      },
                    ),
                    RaisedButton(
                      child: Text('警告toast'),
                      onPressed: () => {
                        // XToast.waring("这是一个警告Toast")
                      },
                    ),
                  ],
                ),
                ...
                ButtonBar(
                  ...
                  children: <Widget>[
                    ...
                    RaisedButton(
                      child: Text('普通toast'),
                      onPressed: () => {
                        // ToastUtils.toast("这是一个普通的Toast")
                      },
                    ),
                    RaisedButton(
                      child: Text('警告toast'),
                      onPressed: () => {
                        // ToastUtils.waring("这是一个警告Toast")
                      },
                    ),
                  ],
                ),
                ButtonBar(
                  ...
                  children: <Widget>[
                    ...
                    RaisedButton(
                      child: Text('成功toast'),
                      onPressed: () => {
                        // ToastUtils.success("这是一个成功Toast")
                      },
                    ),
                  ],
                ),
